...
//奇点小程序：猜你喜欢
public class AppletsRelatedarticle extends TestBase {
    ...
    @Test(description = "奇点小程序：猜你喜欢")
    public void filterCon()throws Exception{

        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost post = new HttpPost("https://api.house.ifeng.com/news/iqidian/applets/relatedarticle?id=52479733&siteId=3066");
        ...
        try{
            if (res.getStatusLine().getStatusCode() == HttpStatus.SC_OK){
               ...
               System.out.println("返回json:"+jsonObject);
                ...
                if (jsonArray.size() != 0){
                    System.out.println("猜你喜欢接口正常,首页数量："+jsonArray.size());
                    Assert.assertTrue(true);
                }else {
                    System.out.println("猜你喜欢异常");
