...
public class Getinfo extends TestBase {
    ...
    public void setUp(){
        ...
        testCaseExecel = System.getProperty("user.dir")+prop.getProperty("Getinfo");
    }
    @DataProvider(name = "postData")
    public Object[][] post() throws IOException{
        return  dtt(testCaseExecel,0);
    }
    @Test(dataProvider = "postData" ,description = "总网：风芒活动-根据id获取风芒活动信息")
    public void filterCon(String contenx)throws Exception{
        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpGet get = new HttpGet("https://fm-api.house.ifeng.com/activity/headquarters/getinfo?id=876&appkey=hq25CHldX8HTfvykQY&sign=1234567890abcdefg");
