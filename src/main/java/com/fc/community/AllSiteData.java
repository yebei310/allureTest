...
public class AllSiteData extends TestBase {
    ...
    public void setUp(){
        ...
        testCaseExecel = System.getProperty("user.dir")+prop.getProperty("AllSiteData");
    }
    @DataProvider(name = "postData")
    public Object[][] post() throws IOException{
        return  dtt(testCaseExecel,0);
    }
    @Test(dataProvider = "postData" ,description = "获取所有站点数据（wap）")
               ...
               JSONObject jsonObject =JSONObject.parseObject(result);
                ...
                if (msgValue.equals("操作成功")){
                    ...
                    if (sites.contains(expectSite)){
                        ...
                        System.out.println("站点数据没有找到"+expectSite);
                        Reporter.log("站点数据没有找到"+expectSite);
