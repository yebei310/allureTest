...
//1 楼盘户型详情页接口(PC/WAP)
public class HouseRoomtypeDetail extends TestBase {
    ...
    @Test(dataProvider = "postData" ,description = "新房：楼盘户型详情页接口(PC/WAP)")
    public void filterCon(String contenx)throws Exception{

        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost post = new HttpPost("https://dict.izhiliao.com/house/api/roomtypeDetail");
            ...
            if (res.getStatusLine().getStatusCode() == HttpStatus.SC_OK){
               ...
               JSONObject jsonObject =JSONObject.parseObject(result);
                ...
                if (msgValue.equals("操作成功")){
                    ...
                    JSONObject jsonObject2 = jsonObject1.getJSONObject("dictRoomtype");
                    String dictName =jsonObject2.getString("name");
                    String expectSite="二期B户型";
                    if (dictName.contains(expectSite)){
                        System.out.println("该楼盘包含："+expectSite);
