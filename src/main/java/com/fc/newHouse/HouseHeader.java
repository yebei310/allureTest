...
//1 楼盘详情头部公用接口(PC)
public class HouseHeader extends TestBase {
    ...
    @Test(dataProvider = "postData" ,description = "新房：楼盘详情头部公用接口(PC)")
    public void filterCon(String contenx)throws Exception{

        CloseableHttpClient httpClient = HttpClients.createDefault();
        HttpPost post = new HttpPost("http://172.17.3.237:8084/house/api/header");
...
//                    JSONObject jsonObject2 = jsonObject1.getJSONObject("basicRsp");
                    String dictName =jsonObject1.getString("dictName");
